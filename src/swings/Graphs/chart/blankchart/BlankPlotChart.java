package swings.Graphs.chart.blankchart;
...
public class BlankPlotChart extends JComponent {
    ...
    public swings.Graphs.chart.blankchart.BlankPlotChatRender getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(swings.Graphs.chart.blankchart.BlankPlotChatRender blankPlotChatRender) {
    ...
    private swings.Graphs.chart.blankchart.NiceScale niceScale;
    private double maxValues;
    private double minValues;
    private int labelCount;
    private String valuesFormat = "#,##0.##";
    private swings.Graphs.chart.blankchart.BlankPlotChatRender blankPlotChatRender;
    ...
    public void initValues(double minValues, double maxValues) {
        ...
        this.maxValues = maxValues;
        niceScale = new swings.Graphs.chart.blankchart.NiceScale(minValues, maxValues);
        repaint();
    }
    ...
    public swings.Graphs.chart.blankchart.SeriesSize getRectangle(int index, double height, double space, double startX, double startY) {
        double x = startX + space * index;
        swings.Graphs.chart.blankchart.SeriesSize size = new swings.Graphs.chart.blankchart.SeriesSize(x, startY + 1, space, height);
        return size;
    }

    public swings.Graphs.chart.blankchart.NiceScale getNiceScale() {
        return niceScale;
    }

    public void setNiceScale(swings.Graphs.chart.blankchart.NiceScale niceScale) {
